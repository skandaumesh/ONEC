...
import {
 ...
 ChevronRight, Minus, Plus, AlertTriangle, Check, Loader2, Package, Sparkles
} from 'lucide-react';
...
export default function ProductDetailPage() {
 ...
 <Link href="/" className="hover:text-[#FF6F61] transition-colors font-bold">Home</Link>
 <ChevronRight size={12} />
 <Link href="/products" className="hover:text-[#FF6F61] transition-colors font-bold">Products</Link>
 <ChevronRight size={12} />
 {p.category && (
 <>
 <Link href={`/products?category=${p.category.id}`} className="hover:text-[#FF6F61] transition-colors font-bold">
 {p.category.name}
 </Link>
 <ChevronRight size={12} />
 </>
 ...
 className="w-12 h-[52px] rounded-2xl bg-purple-50 border-2 border-purple-200 text-purple-600 flex items-center justify-center shadow-sm hover:bg-purple-100 transition-colors cursor-pointer"
 ...
 <Link href="/products" className="text-xs font-black text-[#FF6F61] hover:underline">View All</Link>
 </div>
 </SlideUp>
 ...
 <ScaleOnHover>
 <Link href={`/products/${rp.id}`} className="block rounded-3xl overflow-hidden group glass-blur border border-slate-200/50 shadow-md hover:shadow-xl hover:border-[#FF6F61]/30 hover:-translate-y-1 transition-all duration-300">
