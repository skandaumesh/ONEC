...
export default function LoginPage() {
 ...
 <Link href="/forgot-password" className="font-extrabold text-[var(--color-primary)] hover:underline">Forgot password?</Link>
 </motion.div>
 ...
 <Link href="/register" className="font-black text-[var(--color-primary)] hover:underline">Sign up</Link>
 </p>
 </div>
 </motion.div>
 </div>
