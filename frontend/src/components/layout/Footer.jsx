...
export default function Footer() {
 ...
 <li key={link.name}>
 <Link to={link.path} className="text-sm transition-colors hover:text-primary" style={{ color: 'var(--text-secondary)' }}>
 {link.name}
 </Link>
 </li>
 ))}
 ...
 <li key={cat}>
 <Link to="/products" className="text-sm transition-colors hover:text-primary" style={{ color: 'var(--text-secondary)' }}>
 {cat}
 </Link>
 </li>
 ))}
