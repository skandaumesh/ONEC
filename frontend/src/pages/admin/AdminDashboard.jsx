...
export default function AdminDashboard() {
 ...
 { id: 'inventory', label: 'Expiry & Batches', icon: Layers },
 { id: 'discounts', label: 'Coupons Engine', icon: Percent },
 { id: 'users', label: 'Staff & Patients', icon: Users },
 { id: 'reports', label: 'Sales Intelligence', icon: BarChart3 },
 { id: 'reviews', label: 'Reviews Desk', icon: MessageSquare },
 { id: 'recommendations', label: 'AI Health Models', icon: Sparkles }
 ];
 ...
 <div className="form-group">
 <label className="form-label text-slate-400 text-[10px] font-bold uppercase">Image URL (Mock/Preset)</label>
 <input
