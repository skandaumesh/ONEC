...
export default function AboutPage() {
 ...
 <Link to="/products" className="px-6 py-3.5 bg-[#FF6F61] text-white rounded-2xl font-black text-xs hover:bg-[#E05A4D] transition-all shadow-md hover:shadow-lg flex items-center gap-2 btn-shine">
 Shop Now <ArrowRight size={16} />
 </Link>
 <Link to="/contact" className="px-6 py-3.5 bg-white/80 #141D2F]/80 backdrop-blur border border-slate-200/50 text-[#102A43] rounded-2xl font-black text-xs hover:border-[#FF6F61] transition-all flex items-center justify-center">
 Contact Us
 </Link>
 </div>
 </FadeIn>
